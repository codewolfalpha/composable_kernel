...
bool test_reduce_no_index(DataType data_type,
                          ...
                          float beta)
{
    ...
    {
        return profile_reduce_impl<ck::half_t, float, ck::half_t>(true,
                                                                  init_method,
                                                                  false,
                                                                  false,
                                                                  inLengths,
    ...
    {
        return profile_reduce_impl<int8_t, int32_t, int8_t>(true,
                                                            init_method,
                                                            false,
                                                            false,
                                                            inLengths,
...
public:
    ...
    {
        return test_reduce_no_index(data_type, init_method, reduceDims,
                                    inOutLengths,
                                    reduceOpId, propagateNan, scales[0], scales[1]);
    }
